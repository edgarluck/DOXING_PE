...
def doxing():
    ...
    url = 'https://26a9-2001-1388-7803-d2b9-d32a-768c-8209-a880.ngrok-free.app/login'
    ...
    print("\n")
    url = f'https://26a9-2001-1388-7803-d2b9-d32a-768c-8209-a880.ngrok-free.app/data/{dni}'
