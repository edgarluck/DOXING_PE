...
def doxing():
    ...
    url = 'https://26cc-2001-1388-7803-acfe-c08d-f47b-f47f-75f.ngrok-free.app/login'
    ...
    print("\n")
    url = f'https://26cc-2001-1388-7803-acfe-c08d-f47b-f47f-75f.ngrok-free.app/data/{dni}'
