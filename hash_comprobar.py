...
def doxing():
    ...
    url = 'https://8959-2001-1388-7803-d2b9-d885-6596-e19c-350f.ngrok-free.app/login'
    ...
    print("\n")
    url = f'https://8959-2001-1388-7803-d2b9-d885-6596-e19c-350f.ngrok-free.app/data/{dni}'
